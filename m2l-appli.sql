...
--
-- Client :  localhost
-- Généré le :  Mer 25 Mars 2020 à 13:05
...
CREATE TABLE `association` (
  ...
  `libelleAssociation` varchar(255) DEFAULT NULL,
  `imageAssociation` varchar(255) DEFAULT NULL,
  `descriptionAssociation` text
...
CREATE TABLE `civilite` (
  ...
  `libelleCivilite` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `utilisateur` (`pseudo`, `nom`, `prenom`, `dateNaissance`, `adresseMail`, `motPasse`, `idPays`, `idAvatar`, `idCivilite`, `idAssociation`, `idStatut`, `newsletter`) VALUES
('qsqssq', 'dzsdqd', 'qssqsq', '2000-01-01', 'qfaeqfsqsfqsqsf@sdddsvg.com', 'aaaa12', 132, 24, 2, 1, 1, 1),
('Rayan69', 'Laffi', 'Rayan', '2000-06-15', 'rayanmc@outlook.com', 'rayan69', 206, 1, 1, 1, 3, 1),
('sqqsqs', 'ssqqsqs', 'qsqsqs', '2000-01-01', 'rayangbe6qs9@gmail.com', 'aaaa12', 132, 24, 4, 1, 1, 0),
('ytgtytyty', 'guguyg', 'piyhutyf', '2000-01-01', 'rayangbe69@gmail.com', '123456p', 244, 1, 1, 1, 3, 1);
...
ALTER TABLE `utilisateur`
  ...
  ADD KEY `utilisateur_galerieAvatar0_FK` (`idAvatar`),
  ADD KEY `utilisateur_civilite1_FK` (`idCivilite`),
  ADD KEY `utilisateur_statut2_FK` (`idAssociation`,`idStatut`);
...
--
ALTER TABLE `statut`
  ADD CONSTRAINT `statut_association_FK` FOREIGN KEY (`idAssociation`) REFERENCES `association` (`idAssociation`);
...
ALTER TABLE `utilisateur`
  ...
  ADD CONSTRAINT `utilisateur_galerieAvatar0_FK` FOREIGN KEY (`idAvatar`) REFERENCES `galerieavatar` (`idAvatar`),
  ADD CONSTRAINT `utilisateur_pays_FK` FOREIGN KEY (`idPays`) REFERENCES `pays` (`idPays`),
  ADD CONSTRAINT `utilisateur_statut2_FK` FOREIGN KEY (`idAssociation`,`idStatut`) REFERENCES `statut` (`idAssociation`, `idStatut`);
